...
/* package EpsilonX-0.1.0.0 */
#ifndef VERSION_EpsilonX
#define VERSION_EpsilonX "0.1.0.0"
#endif /* VERSION_EpsilonX */
#ifndef MIN_VERSION_EpsilonX
#define MIN_VERSION_EpsilonX(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_EpsilonX */
...
#define CURRENT_COMPONENT_ID "EpsilonX-0.1.0.0-inplace-EpsilonX"
