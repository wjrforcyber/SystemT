...
module Lang.L5.Tests (unitTests, propertyTests) where

import Data.Maybe
import Lang.L5.Eval.EEval as EE
-- import Lang.L5.Eval.IEval as I
import Lang.L5.Syntax.Extrinsic as E
-- import Lang.L5.Syntax.Intrinsic as I
import Lang.L5.Typecheck
import Test.Tasty
import Test.Tasty.HUnit
import Test.Tasty.QuickCheck as QC

propertyTests :: TestTree
propertyTests = testGroup "L5 Property tests" [tcL5Props, evalL5Props]
